...
img_jimmy_resized = bip.proportional_scaling(img_jimmy,0.1)

# kernel=np.ones((3,3),np.uint8)
# dilate=cv2.dilate(img_jimmy_resized,kernel,iterations=1)
# erosion=cv2.erode(img_jimmy_resized,kernel,iterations=1)
#
